package com.test.jhipster.config.timezone;

import com.test.jhipster.JhipsterApp;
import com.test.jhipster.repository.timezone.DateTimeWrapper;
import com.test.jhipster.repository.timezone.DateTimeWrapperRepository;
